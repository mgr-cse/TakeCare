...
public class FieldGetter extends AsyncTask<String, Integer, String> {

    private String key, field, table;
    Context context;

    public FieldGetter(Context context, String key, String field, String table)
    {
        this.key = key;
        this.field = field;
        this.table = table;
    ...
    protected String doInBackground(String... strings) {
        ...
        String link = host + "api/fieldgetter.php" +
                "?key=" + key +
                "&field=" + field +
                "&table=" + table;
